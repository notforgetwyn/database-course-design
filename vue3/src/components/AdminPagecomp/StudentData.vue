<template lang="">
        <el-form :inline="true" :model="searchForm">
            ...
            <el-table-column prop="teacherId" label="老师ID" width="150"></el-table-column>
            <el-table-column prop="teacherName" label="老师姓名" width="150"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    mutipdele() {
      ...
      if (num == 0) return;
      requests.post("student/dels", num).then(result => {
        if (result.data.code === 200) {
          this.tableData = result.data.data;
          this.$message.success(result.data.message)
        }
