...
<el-dialog v-model="dialogTableVisible" title="编辑" width="750px" center>
    <el-form :inline="true" :model="dialogData" label-width="120px">
        <el-form-item class="login-input" label="申请ID">
        ...
        <el-form-item class="login-input" label="教师批准">
            <el-input v-model="dialogData.teacherApproval"></el-input>
        </el-form-item>
        ...
        <el-form-item class="login-input" label="补充">
            <el-input v-model="dialogData.updatedAt"></el-input>
        </el-form-item>
    </el-form>
    <template #footer>
