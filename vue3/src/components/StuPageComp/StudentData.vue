...
<el-descriptions-item label="老师ID" label-align="center" align="center">
    {{teacherId}}
</el-descriptions-item>
<el-descriptions-item label="老师名字" label-align="center" align="center">
    {{teacherName}}
</el-descriptions-item>
<el-descriptions-item label="通讯地址" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="家长信息" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="毕业中学" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="考区" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="宿舍地址" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="培养层次" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="培养方式" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
<el-descriptions-item label="分流方向" label-align="center" align="center">
    {{id}}
</el-descriptions-item>
...
<el-dialog v-model="dialogTableVisible" title="编辑" width="750px" center>
    <el-form :inline="true" :model="dialogData" label-width="120px">
        ...
        <el-form-item class="login-input" label="学生姓名">
            <el-input v-model="dialogData.studentName" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        submit() {
            requests.post('student', this.dialogData).then(result => {
                if (result.data.code === 200) {
